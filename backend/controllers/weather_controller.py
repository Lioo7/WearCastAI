...
# example: http://127.0.0.1:5000/api/v1/forecast-by-coordinates?latitude=32.085300&longitude=34.781769#
@blueprint.route('/forecast-by-coordinates', methods=['GET'])
...
# example: http://127.0.0.1:5000/api/v1/forecast-by-city?city=Tel-Aviv
@blueprint.route('/forecast-by-city', methods=['GET'])
